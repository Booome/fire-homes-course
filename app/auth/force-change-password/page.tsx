...
import { buttonBaseClasses } from "@/lib/consts";
...
import { z } from "zod";
import { cardBaseClasses, cardTitleClasses } from "../lib/consts";
...
function ForceChangePasswordContent() {
  ...
  return email ? (
    <Card className={cardBaseClasses}>
      <CardTitle className={cardTitleClasses}>Reset Password</CardTitle>
